...
export function PrimaryCTA({ href, children }) {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.96 }}
      animate="rest"
      className="group relative inline-flex items-center gap-2 overflow-hidden rounded-full px-6 py-3 text-sm font-semibold text-on-accent"
      style={{
        background:
    ...
    >
      ...
      <motion.span
        ...
        className="relative grid h-6 w-6 place-items-center rounded-full bg-on-accent/20"
      >
